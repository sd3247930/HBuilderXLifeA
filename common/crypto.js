/**
 * 跨端本地密码工具（H5 / App / 微信小程序通用，无外部依赖）。
 * 说明：使用内置实现的 SHA-256 + 随机盐，避免引入 crypto-js 等 npm 包；
 * 仅用于本地账户演示场景。若正式产品需要强安全等级，应改用服务端 scrypt/argon2。
 */
...
export function hashPassword(password, salt) {
  return sha256Hex('lifestyleapp:' + salt + ':' + password)
}
